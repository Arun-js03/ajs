    ...
    <div className="space-top relative">
      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 items-center gap-8 absolute z-10 top-0 left-0 right-0 h-full">
        <div className="space-y-4  text-white">
          <h2 className="font-semibold italic text-2xl">About Us</h2>

          <h2 className="font-semibold text-3xl">
            We Are Your Turnkey Partners in
          </h2>
          <h3 className="font-semibold text-5xl bg-[linear-gradient(180deg,#FF8A99_0%,#D00515_78.85%)] bg-clip-text text-transparent">
            Web Development
          </h3>
        ...
        <div>
          ...
          <div className="text-white grid grid-cols-2 items-center gap-8 px-8 justify-center mt-3">
            {years.map((year) => (
              ...
              >
                <h4 className="font-semibold text-3xl ">{year.value}</h4>
                <div className="font-semibold text-3xl italic">
                  {year.title}
                </div>
              </div>
            ))}
